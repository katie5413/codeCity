...
{positionDragY(y,animate)},animate:function(ele,prop,value,stepCallback,completeCallback)
{var params={};params[prop]=value;ele.animate(params,{'duration':settings.animateDuration,'easing':settings.animateEase,'queue':!1,'step':stepCallback,'complete':completeCallback})},getContentPositionX:function()
